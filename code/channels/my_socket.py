...
class SocketIOOutput(OutputChannel):
    ...
    async def send_text_with_buttons(
        ...
        **kwargs: Any,
        ...
        #type of buttons 'quick_replies' or 'buttons'
        type_of_buttons = kwargs.get('buttons_type', 'buttons')
        ...
        messages = [{"text": message, type_of_buttons: []} for message in message_parts]

        # attach all buttons to the last text fragment
        for button in buttons:
            messages[-1][type_of_buttons].append(
                {
                    "content_type": "text",
                    "title": button["title"],
